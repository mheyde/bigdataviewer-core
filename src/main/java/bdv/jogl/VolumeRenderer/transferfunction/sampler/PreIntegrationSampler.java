...
import bdv.jogl.VolumeRenderer.shaderprogram.shadersource.function.transferfunctionclassifier.PreIntegrationClassifier;
...
public class PreIntegrationSampler implements ITransferFunctionSampler {
	...
	public void init(GL4 gl, int colorTextureId) {
		...
		colorTexture.setTexParameteri(GL2.GL_TEXTURE_WRAP_T, GL2.GL_CLAMP_TO_BORDER);
